...
public class Abilities {
    ...
    private static AbilityCore<?>[] opeAbilities() {
        if (WyHelper.isAprilFirst()) return new AbilityCore[]{RoomAbility.INSTANCE, KRoomAbility.INSTANCE, TrueAmputateAbility.INSTANCE, ShamblesAbility.INSTANCE, TaktAbility.INSTANCE, InjectionShotAbility.INSTANCE, CounterShockAbility.INSTANCE, MesAbility.INSTANCE, GammaKnifeAbility.INSTANCE, FuroShujutsuAbility.INSTANCE};
        return new AbilityCore[]{RoomAbility.INSTANCE, KRoomAbility.INSTANCE, TrueAmputateAbility.INSTANCE, ShamblesAbility.INSTANCE, TaktAbility.INSTANCE, InjectionShotAbility.INSTANCE, CounterShockAbility.INSTANCE, MesAbility.INSTANCE, GammaKnifeAbility.INSTANCE};
    }
